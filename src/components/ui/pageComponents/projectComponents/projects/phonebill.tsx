    ...
    <AnimateTx>
      <div className="my-8 mx-5">
        <div className="text-center">
          <Link
            href="https://github.com/NAlexH2/phonebill-android-project"
            passHref={true}
            target="_blank"
        ...
        <div className="text-justify">
          <p>
            This was a project that was given to me during my summer 2022 term
            at Portland State University in the &#34;Advanced Programming with
          ...
          <p className="mt-3">
            The previous projects took on different forms using basic command
            line programs which took in command line arguments to handle the
            user&#39;s request. Each of these projects required tests to support
            sufficient code coverage and included documentation as well.
          </p>
          <p className="mt-3">
            The first required simply adding and tracking a single customers
            bill The second required tracking the customer&#39;s bill in a text
            file The third required tracking multiple customers, the dates,
            times, duration, and sorting based on the date/time. If date/time
            were the same, then sort by the phone number and finally &#34;pretty
          ...
          <p className="mt-3">
            ...
            kept in volatile memory and not stored permanently in any sort of
            way. The requirements were fairly similar to the previous projects
            (aside from the fourth). It had to store data, be human readable,
            and searchable.
          </p>
          <p className="mt-3">
